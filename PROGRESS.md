...
1. **Настроить HTTPS** — нужен домен для SSL сертификата
2. **Подключить фронтенд** — связать Lovable с API
3. **Телефония** — MTS Exolve или Novofon
