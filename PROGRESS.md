...
### 1. Телефония (MTS Exolve)
- Подключить ScenarioEngine к VoiceAgent
- Загружать сценарии из YAML конфигов
- Управлять этапами диалога

### 2. Телефония (MTS Exolve)
- Подключить SIP trunk
- Входящие звонки → LiveKit
- Исходящие звонки

### 3. RAG System (Qdrant)
- База знаний для ботов
- Поиск по документам клиента
...
| 2026-01-12 | Создан Scenario Engine (95%) |
